...
public class Imageprocess extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comboOne.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "None", "DES", "Blowfish", "AES" }));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            {                
                FileInputStream file=new FileInputStream(file_path.getText());
                FileOutputStream outStream=new FileOutputStream("Blowfishdecrypt.jpg");
                ...
                outStream.flush();
                cos.close();
                JOptionPane.showMessageDialog(null, "The Blowfish Decrypt is Successful !!");
